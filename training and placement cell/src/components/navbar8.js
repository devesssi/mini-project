          ...
          <div className="navbar8-buttons1">
            ...
            <button className="navbar8-action21 thq-button-outline thq-button-animated">
              <span className="thq-body-small">
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text27">Apply Now</span>
                  </Fragment>
                )}
              </span>
            </button>
                            ...
                            {props.page1Description ?? (
                              <Fragment>
                                <span className="navbar8-text22 thq-body-small">
                                  Welcome to the SLRTCE Training and Placement
                                  Cell.
                                </span>
                              </Fragment>
                            )}
                            ...
                            {props.page2Description ?? (
                              <Fragment>
                                <span className="navbar8-text23 thq-body-small">
                                  Learn more about the SLRTCE Training and
                                  Placement Cell.
                                </span>
                              </Fragment>
                            )}
                  ...
                  <div className="navbar8-content6">
                    ...
                    <span>
                      {props.page2Description ?? (
                        <Fragment>
                          <span className="navbar8-text23 thq-body-small">
                            Learn more about the SLRTCE Training and Placement
                            Cell.
                          </span>
                        </Fragment>
                      )}
...
Navbar8.defaultProps = {
  ...
  page1ImageSrc:
    'https://images.unsplash.com/photo-1645821522733-8eb2015f36a7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyNzk2NjcxMnw&ixlib=rb-4.0.3&q=80&w=1080',
  action1: undefined,
  page2ImageAlt: 'Image for About Us',
  link2: undefined,
  linkUrlPage2: 'https://www.teleporthq.io',
  logoAlt: 'SLRTCE Training and Placement Cell',
  logoSrc:
    'https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/84ec08e8-34e9-42c7-9445-d2806d156403/fac575ac-7a41-484f-b7ac-875042de11f8?org_if_sml=1&force_format=original',
  page3ImageAlt: 'Image for Training Programs',
  ...
  page2: undefined,
  link4: undefined,
  page4ImageAlt: 'Image for Placement Opportunities',
  page1Description: undefined,
  page2ImageSrc:
    'https://images.unsplash.com/photo-1640622332859-55e65253475d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyNzk2NjcxM3w&ixlib=rb-4.0.3&q=80&w=1080',
  page3ImageSrc:
    'https://images.unsplash.com/photo-1631048006733-4ff06e22deef?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyNzk2NjcxM3w&ixlib=rb-4.0.3&q=80&w=1080',
